...
@override
String toString() {
  return 'DetailModel(id: $id, name: $name, status: $status, species: $species, type: $type, gender: $gender, origin: $origin, location: $location, image: $image, episode: $episode, url: $url, created: $created)';
}
...
class _DetailModel extends DetailModel {
   _DetailModel({required this.id, required this.name, required this.status, required this.species, required this.type, required this.gender, required this.origin, required this.location, required this.image, required final  List<String> episode, required this.url, required this.created}): _episode = episode,super._();
...
class _LocationModel extends LocationModel {
   _LocationModel({required this.name, required this.url}): super._();
